...
public class WeatherReportAggregator : IWeatherReportAggregator
{
  ...
  {
    var endpoint = BuildTemperatureEnpoint(zip, days);
  ...
  private string BuildTemperatureEnpoint(string zip, int days)
  {
  ...
  private string BuildPrecipitationEnpoint(string zip, int days)
  {
